...
// Iris dataset
export const iris = await readCsv('./test/data/iris.csv');

// Very Small DataFrames
export const verySmallDataFrame1 = new DataFrame(
  [
    { id: 1, name: 'billy' },
    { id: 2, name: 'jane' },
    { id: 3, name: 'roger' },
...
export const verySmallDataFrame2 = new DataFrame(
  [
...
export const verySmallDataFrame3 = new DataFrame(
  [
...
export const verySmallDataFrame4 = new DataFrame(
  [
...
export const verySmallValidObjArray = [
  { id: 1, name: 'billy' },
  { id: 2, name: 'jane' },
  { id: 3, name: 'roger' },
];

export const verySmallInvalidObjArray = [
  { id: 1, name: 'billy' },
  { name: 'jane' },
  { id: 3, name: 'roger' },
];
...
// Small DataFrames
export const smallDataFrame1 = new DataFrame(
  [
...
export const smallDataFrame2 = new DataFrame(
  [
    { id: 100, name: 'billy', weight: 102 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 5, name: 'roger', weight: 107 },
...
export const smallDataFrame3 = new DataFrame(
  [
...
export const smallDataFrame4 = new DataFrame(
  [
...
export const smallDataFrame5 = new DataFrame(
  [
...
export const smallDataFrame6 = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'red', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
...
export const verySmallDataFrameCrossJoinResult = new DataFrame(
  [
...
export const verySmallDataFrameInnerJoinResult = new DataFrame(
  [
    { id: 1, name: 'billy', age: 10 },
    { id: 2, name: 'jane', age: 20 },
  ],
...
export const verySmallDataFrameLeftJoinResult = new DataFrame(
  [
    { id: 1, name: 'billy', age: 10 },
    { id: 2, name: 'jane', age: 20 },
...
export const verySmallDataFrameRightJoinResult = new DataFrame(
  [
    { id: 1, name: 'billy', age: 10 },
    { id: 2, name: 'jane', age: 20 },
    { id: 4, name: 'gary', age: 40 },
...
export const verySmallDataFrameLeftAntiJoinResult = new DataFrame(
  [{ id: 3, name: 'roger', age: null }],
  ['id', 'name', 'age'],
);

// Right anti join of verySmallDataFrame1 and verySmallDataFrame2
export const verySmallDataFrameRightAntiJoinResult = new DataFrame(
  [{ id: 4, name: 'gary', age: 40 }],
  ['id', 'name', 'age'],
);

// Full outer join of verySmallDataFrame2 and verySmallDataFrame4
export const verySmallDataFrameFullOuterJoinResult = new DataFrame(
  [
...
export const smallDataFrame1OrderByIdResult = new DataFrame(
  [
    { id: 1, name: 'joseph', weight: 71 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 3, name: 'jennifer', weight: 84 },
...
export const smallDataFrame1OrderByNameResult = new DataFrame(
  [
    { id: 201, name: 'alex', weight: 95 },
    { id: 100, name: 'billy', weight: 102 },
    { id: 78, name: 'carl', weight: 86 },
...
export const smallDataFrame1OrderByIdWeightResult = new DataFrame(
  [
    { id: 1, name: 'joseph', weight: 71 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 3, name: 'jennifer', weight: 84 },
...
export const smallDataFrame1OrderByIdDescWeightAscResult = new DataFrame(
  [
    { id: 201, name: 'alex', weight: 95 },
    { id: 169, name: 'dwayne', weight: 99 },
    { id: 101, name: 'elon', weight: 74 },
...
// groupBy of iris by
export const irisGroupBySpeciesResult = new DataFrame(
  [
    {
      species: 'setosa',
...
//  filter results
export const smallDataFrame1FilterIdResult = new DataFrame(
  [
    { id: 100, name: 'billy', weight: 102 },
    { id: 100, name: 'sean', weight: 85 },
  ],
...
export const smallDataFrame1FilterWeightResult = new DataFrame(
  [
    { id: 1, name: 'joseph', weight: 71 },
    { id: 23, name: 'fred', weight: 62 },
    { id: 101, name: 'elon', weight: 74 },
...
// distinct results
export const smallDataFrame2DistinctAllResult = new DataFrame(
  [
    { id: 100, name: 'billy', weight: 102 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 5, name: 'roger', weight: 107 },
...
export const smallDataFrame2DistinctIdResult = new DataFrame(
  [
    { id: 100, name: 'billy', weight: 102 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 5, name: 'roger', weight: 107 },
...
export const smallDataFrame2DistinctNameWeightResult = new DataFrame(
  [
    { id: 100, name: 'billy', weight: 102 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 5, name: 'roger', weight: 107 },
...
// window functions
export const smallDataFrame3WindowFuncsOrderedPartition = new DataFrame(
  [
    {
      name: 'Noel',
      dept: 1,
...
export const smallDataFrame3WindowFuncsWindowSize = new DataFrame(
  [
    {
      name: 'Noel',
      dept: 1,
...
// replace Name r -> rrr
export const smallDataFrame4ReplaceName = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'red', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
...
export const smallDataFrame4ReplaceNameColour = new DataFrame(
  [
...
export const smallDataFrame4ReplaceAllName = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'red', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
...
export const smallDataFrame4ReplaceAllNameColour = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'rrred', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
...
export const smallDataFrame4RegexReplaceName = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'red', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
    { id: 5, name: 'rrroger', colour: 'green', weight: 107 },
...
export const smallDataFrame4RegexReplaceNameGlobal = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'red', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
    { id: 5, name: 'rrrogerrr', colour: 'green', weight: 107 },
...
export const smallDataFrame4RegexReplaceNameColourGlobal = new DataFrame(
  [
    { id: 100, name: 'billy', colour: 'rrred', weight: 102 },
    { id: 2, name: 'jane', colour: 'blue', weight: 97 },
    { id: 5, name: 'rrrogerrr', colour: 'grrreen', weight: 107 },
...
// unionByName
export const smallDataFrame1and2UnionByName = new DataFrame(
  [
    { id: 100, name: 'billy', weight: 102 },
    { id: 2, name: 'jane', weight: 97 },
    { id: 5, name: 'roger', weight: 107 },
