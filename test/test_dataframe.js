...
describe('DataFrame class', () => {
  ...
  describe('Row iteration', () => {
    it('Should allow iteration over DataFrame rows in a for...of loop', () => {
      ...
      expect(rowChecker['id']).to.equal(
        verySmallDataFrame1.slice(-1).toArray()[0]['id'],
      );
    });
    ...
    it('Should allow destructuring DataFrame rows', () => {
      const df = [...verySmallDataFrame1];
      // Compare the
      expect(df.slice(-1)[0]['id']).to.equal(
        verySmallDataFrame1.slice(-1).toArray()[0]['id'],
      );
    });
  });
  ...
  describe('select()', function () {
    ...
    it('Should throw an error if at least one column does not exist in the DataFrame', function () {
      expect(() => {
        this.test.df.select('id', 'colthatdoesnotexist');
      }).to.throw();
    });
  ...
  describe('drop()', function () {
    ...
    it('Should throw an error if at least one column does not exist in the DataFrame', function () {
      expect(() => {
        this.test.df.drop('id', 'colthatdoesnotexist');
      }).to.throw();
    });
  ...
  describe('withColumn()', function () {
    ...
    it('Should throw an error if column name is invalid', function () {
      // Is not a string
      expect(() => {
        this.test.df.withColumn(1, () => 1);
      }).to.throw();
      expect(() => {
        this.test.df.withColumn(undefined, () => 1);
      }).to.throw();
      expect(() => {
        this.test.df.withColumn(null, () => 1);
      }).to.throw();
      // Starts with a number
      expect(() => {
        this.test.df.withColumn('1newCol', () => 1);
      }).to.throw();
      ...
      [
        ...
        expect(() => {
          this.test.df.withColumn(invalidChar + 'newCol', () => 1);
        }).to.throw();
      });
    });
    ...
    it('Should overwrite the values of a column when an existing column name is specified', function () {
      ...
      const df = this.test.df
        .withColumn(newColName, () => 1)
        .withColumn(newColName, () => 2);

      const numInstances = df.columns.filter(
        (col) => col === newColName,
      ).length;
  ...
  describe('crossJoin()', function () {
    ...
    it('Should return the cross join between two DataFrames', function () {
      const result = this.test.df1.crossJoin(this.test.df2);
      expect(result.toArray()).to.deep.equal(
        this.test.crossJoinResultDf.toArray(),
      );
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      ...
      expect(() =>
        this.test.df1.crossJoin([{ id: 1, name: 'test' }]),
      ).to.throw();
    });
    ...
    it('Should throw an error if more than one argument is passed', function () {
      expect(() =>
        this.test.df1.crossJoin(this.test.df2, (l, r) => l.id === r.id),
      ).to.throw();
    });
  });
  ...
  describe('innerJoin()', function () {
    ...
    it('Should return the inner join between two DataFrames when using a single array join condition', function () {
      const result = this.test.df1.innerJoin(this.test.df2, ['id', 'name']);
      expect(result.toArray()).to.deep.equal(
        this.test.innerJoinResultDf.toArray(),
      );
    ...
    it('Should return the inner join between two DataFrames when using left and right array join conditions', function () {
      const result = this.test.df1.innerJoin(
        this.test.df2,
        ['id', 'name'],
        ['id', 'name'],
      );
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      expect(
        () => this.test.df1.innerJoin(() => 'should error'),
        ['id'],
      ).to.throw();
    });
    ...
    it('Should throw an error if more than three arguments are passed', function () {
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['id'], 1, 1),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a single array join condition', function () {
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['invalidCol']),
      ).to.throw();
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['id', 'invalidCol']),
      ).to.throw();
    });
    ...
    it('Should throw an error if a non-existent column is passed using left and right array join conditions', function () {
      ...
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['invalidCol'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['id', 'invalidCol'], ['id']),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a function join condition', function () {
      expect(() =>
        this.test.df1.innerJoin(
          this.test.df2,
          (l, r) => l.id === r.id && r.invalidCol === 'test',
        ),
      ).to.throw();
      expect(() =>
        this.test.df1.innerJoin(
    ...
    it('Should throw an error if an empty array is passed using left and right array join conditions', function () {
      expect(() => this.test.df1.innerJoin(this.test.df2, [], [])).to.throw();
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['id'], []),
      ).to.throw();
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, [], ['id']),
      ).to.throw();
    ...
    it('Should throw an error if an left and right array join conditions are of different lengths', function () {
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['id'], ['id', 'name']),
      ).to.throw();
    });
    ...
    it('Should throw an error if there are overlapping columns using left and right array join conditions', function () {
      expect(() =>
        this.test.df1.innerJoin(this.test.df2, ['id'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.innerJoin(this.test.df3, ['id'], ['idCol']),
      ).to.throw();
    });
  });
  ...
  describe('leftJoin()', function () {
    ...
    it('Should return the left join between two DataFrames when using a single array join condition', function () {
      const result = this.test.df1.leftJoin(this.test.df2, ['id', 'name']);
      expect(result.toArray()).to.deep.equal(
        this.test.leftJoinResultDf.toArray(),
      );
    ...
    it('Should return the left join between two DataFrames when using left and right array join conditions', function () {
      const result = this.test.df1.leftJoin(
        this.test.df2,
        ['id', 'name'],
        ['id', 'name'],
      );
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      expect(
        () => this.test.df1.leftJoin(() => 'should error'),
        ['id'],
      ).to.throw();
    });
    ...
    it('Should throw an error if more than three arguments are passed', function () {
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['id'], 1, 1),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a single array join condition', function () {
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['invalidCol']),
      ).to.throw();
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['id', 'invalidCol']),
      ).to.throw();
    });
    ...
    it('Should throw an error if a non-existent column is passed using left and right array join conditions', function () {
      ...
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['invalidCol'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['id', 'invalidCol'], ['id']),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a function join condition', function () {
      expect(() =>
        this.test.df1.leftJoin(
          this.test.df2,
          (l, r) => l.id === r.id && r.invalidCol === 'test',
        ),
      ).to.throw();
    ...
    it('Should throw an error if an empty array is passed using left and right array join conditions', function () {
      expect(() => this.test.df1.leftJoin(this.test.df2, [], [])).to.throw();
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['id'], []),
      ).to.throw();
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, [], ['id']),
      ).to.throw();
    ...
    it('Should throw an error if an left and right array join conditions are of different lengths', function () {
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['id'], ['id', 'name']),
      ).to.throw();
    });
    ...
    it('Should throw an error if there are overlapping columns using left and right array join conditions', function () {
      expect(() =>
        this.test.df1.leftJoin(this.test.df2, ['id'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.leftJoin(this.test.df3, ['id'], ['idCol']),
      ).to.throw();
    });
  });
  ...
  describe('rightJoin()', function () {
    ...
    it('Should return the right join between two DataFrames when using a single array join condition', function () {
      const result = this.test.df1.rightJoin(this.test.df2, ['id', 'name']);
      expect(result.toArray()).to.deep.equal(
        this.test.rightJoinResultDf.toArray(),
      );
    ...
    it('Should return the right join between two DataFrames when using right and right array join conditions', function () {
      const result = this.test.df1.rightJoin(
        this.test.df2,
        ['id', 'name'],
        ['id', 'name'],
      );
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      expect(
        () => this.test.df1.rightJoin(() => 'should error'),
        ['id'],
      ).to.throw();
    });
    ...
    it('Should throw an error if more than three arguments are passed', function () {
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['id'], 1, 1),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a single array join condition', function () {
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['invalidCol']),
      ).to.throw();
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['id', 'invalidCol']),
      ).to.throw();
    });
    ...
    it('Should throw an error if a non-existent column is passed using right and right array join conditions', function () {
      ...
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['invalidCol'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['id', 'invalidCol'], ['id']),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a function join condition', function () {
      expect(() =>
        this.test.df1.rightJoin(
          this.test.df2,
          (l, r) => l.id === r.id && r.invalidCol === 'test',
        ),
      ).to.throw();
    ...
    it('Should throw an error if an empty array is passed using right and right array join conditions', function () {
      expect(() => this.test.df1.rightJoin(this.test.df2, [], [])).to.throw();
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['id'], []),
      ).to.throw();
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, [], ['id']),
      ).to.throw();
    ...
    it('Should throw an error if an right and right array join conditions are of different lengths', function () {
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['id'], ['id', 'name']),
      ).to.throw();
    });
    ...
    it('Should throw an error if there are overlapping columns using right and right array join conditions', function () {
      expect(() =>
        this.test.df1.rightJoin(this.test.df2, ['id'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.rightJoin(this.test.df3, ['id'], ['idCol']),
      ).to.throw();
    });
  });
  ...
  describe('leftAntiJoin()', function () {
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      expect(
        () => this.test.df1.leftAntiJoin(() => 'should error'),
        ['id'],
      ).to.throw();
    });
    ...
    it('Should throw an error if more than three arguments are passed', function () {
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['id'], 1, 1),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a single array join condition', function () {
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['invalidCol']),
      ).to.throw();
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['id', 'invalidCol']),
      ).to.throw();
    });
    ...
    it('Should throw an error if a non-existent column is passed using left and right array join conditions', function () {
      ...
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['invalidCol'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['id', 'invalidCol'], ['id']),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a function join condition', function () {
      expect(() =>
        this.test.df1.leftAntiJoin(
          this.test.df2,
          (l, r) => l.id === r.id && r.invalidCol === 'test',
        ),
      ).to.throw();
    ...
    it('Should throw an error if an empty array is passed using left and right array join conditions', function () {
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, [], []),
      ).to.throw();
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['id'], []),
      ).to.throw();
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, [], ['id']),
      ).to.throw();
    ...
    it('Should throw an error if an left and right array join conditions are of different lengths', function () {
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['id'], ['id', 'name']),
      ).to.throw();
    });
    ...
    it('Should throw an error if there are overlapping columns using left and right array join conditions', function () {
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df2, ['id'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.leftAntiJoin(this.test.df3, ['id'], ['idCol']),
      ).to.throw();
    });
  });
  ...
  describe('rightAntiJoin()', function () {
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      expect(
        () => this.test.df1.rightAntiJoin(() => 'should error'),
        ['id'],
      ).to.throw();
    });
    ...
    it('Should throw an error if more than three arguments are passed', function () {
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['id'], 1, 1),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a single array join condition', function () {
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['invalidCol']),
      ).to.throw();
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['id', 'invalidCol']),
      ).to.throw();
    });
    ...
    it('Should throw an error if a non-existent column is passed using right and right array join conditions', function () {
      ...
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['invalidCol'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.rightAntiJoin(
          this.test.df2,
          ['id', 'invalidCol'],
          ['id'],
        ),
    ...
    it('Should throw an error if an empty array is passed using right and right array join conditions', function () {
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, [], []),
      ).to.throw();
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['id'], []),
      ).to.throw();
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, [], ['id']),
      ).to.throw();
    ...
    it('Should throw an error if an right and right array join conditions are of different lengths', function () {
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['id'], ['id', 'name']),
      ).to.throw();
    });
    ...
    it('Should throw an error if there are overlapping columns using right and right array join conditions', function () {
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df2, ['id'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.rightAntiJoin(this.test.df3, ['id'], ['idCol']),
      ).to.throw();
    });
  });
  ...
  describe('fullOuterJoin()', function () {
    ...
    it('Should throw an error if a DataFrame is not passed', function () {
      expect(
        () => this.test.df1.fullOuterJoin(() => 'should error'),
        ['id'],
      ).to.throw();
    });
    ...
    it('Should throw an error if more than three arguments are passed', function () {
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['id'], 1, 1),
      ).to.throw();
    });

    it('Should throw an error if a non-existent column is passed using a single array join condition', function () {
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['invalidCol']),
      ).to.throw();
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['id', 'invalidCol']),
      ).to.throw();
    });
    ...
    it('Should throw an error if a non-existent column is passed using right and right array join conditions', function () {
      ...
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['invalidCol'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.fullOuterJoin(
          this.test.df2,
          ['id', 'invalidCol'],
          ['id'],
        ),
    ...
    it('Should throw an error if an empty array is passed using right and right array join conditions', function () {
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, [], []),
      ).to.throw();
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['id'], []),
      ).to.throw();
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, [], ['id']),
      ).to.throw();
    ...
    it('Should throw an error if an right and right array join conditions are of different lengths', function () {
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['id'], ['id', 'name']),
      ).to.throw();
    });
    ...
    it('Should throw an error if there are overlapping columns using right and right array join conditions', function () {
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df2, ['id'], ['id']),
      ).to.throw();
      expect(() =>
        this.test.df1.fullOuterJoin(this.test.df3, ['id'], ['idCol']),
      ).to.throw();
    });
  });
  ...
  describe('orderBy()', function () {
    beforeEach(function () {
      ...
      this.currentTest.orderByIdWeightResultDf =
        smallDataFrame1OrderByIdWeightResult;
      this.currentTest.orderByIdWeightDescResultDf =
        smallDataFrame1OrderByIdDescWeightAscResult;
    });

    it('Should return a new DataFrame ordered by the specified columns and sort order', function () {
      const result1 = this.test.df.orderBy(['id']);
      expect(result1.toArray()).to.deep.equal(
        this.test.orderByIdResultDf.toArray(),
      );
      expect(result1.columns).to.deep.equal(
        this.test.orderByIdResultDf.columns,
      );

      const result2 = this.test.df.orderBy(['name']);
      expect(result2.toArray()).to.deep.equal(
        this.test.orderByNameResultDf.toArray(),
      );
      expect(result2.columns).to.deep.equal(
        this.test.orderByNameResultDf.columns,
      );

      const result3 = this.test.df.orderBy(['id', 'weight']);
      expect(result3.toArray()).to.deep.equal(
        this.test.orderByIdWeightResultDf.toArray(),
      );
      expect(result3.columns).to.deep.equal(
        this.test.orderByIdWeightResultDf.columns,
      );

      const result4 = this.test.df.orderBy(['id', 'weight'], ['desc', 'asc']);
      expect(result4.toArray()).to.deep.equal(
        this.test.orderByIdWeightDescResultDf.toArray(),
      );
      expect(result4.columns).to.deep.equal(
        this.test.orderByIdWeightDescResultDf.columns,
      );
    });
  ...
  describe('groupBy()', function () {
    ...
    it('Should return a new DataFrame grouped by the specified columns with the specified aggregations', function () {
      const result1 = this.test.df.groupBy(['species'], {
        sepal_length: ['min', 'max', 'mean', 'count', 'sum'],
      });
      expect(result1.toArray()).to.deep.equal(
        this.test.groupBySpeciesResultDf.toArray(),
      );
      expect(result1.columns).to.deep.equal(
        this.test.groupBySpeciesResultDf.columns,
      );
    });
  ...
  describe('filter()', function () {
    ...
    it('Should return a new DataFrame filtered by the specified columns', function () {
      const resultId = this.test.df.filter((row) => row['id'] === 100);
      const resultWeight = this.test.df.filter((row) => row['weight'] < 80);

      // Filter based on id
      expect(resultId.toArray()).to.deep.equal(
        this.test.filterIdResultDf.toArray(),
      );
      expect(resultId.columns).to.deep.equal(
        this.test.filterIdResultDf.columns,
      );

      // Filter based on weight
      expect(resultWeight.toArray()).to.deep.equal(
        this.test.filterWeightResultDf.toArray(),
      );
      expect(resultWeight.columns).to.deep.equal(
        this.test.filterWeightResultDf.columns,
      );
    });
    ...
    it('Should throw an error when a type other than a function is passed', function () {
      expect(() => {
        this.test.df.filter(1);
      }).to.throw();
      expect(() => {
        this.test.df.filter('stringInsteadOfFunction');
      }).to.throw();
    });

    it('Should throw an error if more than one argument is passed', function () {
      expect(() => {
        this.test.df.filter((row) => row['weight'] < 80, 'test');
      }).to.throw();
    });
  });
  ...
  describe('distinct()', function () {
    beforeEach(function () {
      ...
      this.currentTest.distinctNameWeightResultDf =
        smallDataFrame2DistinctNameWeightResult;
    });

    it('Should return a new DataFrame with duplicate rows dropped as per the specified columns', function () {
      const resultAll = this.test.df.distinct();
      const resultId = this.test.df.distinct(['id']);
      const resultNameWeight = this.test.df.distinct(['name', 'weight']);

      // Distinct based on all columns
      expect(resultAll.toArray()).to.deep.equal(
        this.test.distinctAllResultDf.toArray(),
      );
      expect(resultAll.columns).to.deep.equal(
        this.test.distinctAllResultDf.columns,
      );

      // Distinct based on id
      expect(resultId.toArray()).to.deep.equal(
        this.test.distinctIdResultDf.toArray(),
      );
      expect(resultId.columns).to.deep.equal(
        this.test.distinctIdResultDf.columns,
      );

      // Distinct based on name and weight
      expect(resultNameWeight.toArray()).to.deep.equal(
        this.test.distinctNameWeightResultDf.toArray(),
      );
      expect(resultNameWeight.columns).to.deep.equal(
        this.test.distinctNameWeightResultDf.columns,
      );
    });

    it('Should throw an error when a type other than an array is passed', function () {
      expect(() => {
        this.test.df.distinct(1);
      }).to.throw();
      expect(() => {
        this.test.df.distinct('stringInsteadOfFunction');
      }).to.throw();
    });

    it('Should throw an error when referencing a non-existent column', function () {
      expect(() => {
        this.test.df.distinct(['nonExistingColumn']);
      }).to.throw();
    });

    it('Should throw an error if more than one argument is passed', function () {
      expect(() => {
        this.test.df.distinct(['name', 'weight'], 'anotherArgument');
      }).to.throw();
    });
  });
  ...
  describe('replace()', function () {
    beforeEach(function () {
      ...
      this.currentTest.replaceNameColourResultDf =
        smallDataFrame4ReplaceNameColour;
    });

    it('Should return a new DataFrame with values correctly replaced across the specified columns', function () {
      const resultName = this.test.df.replace(['name'], 'r', 'rrr');
      const resultNameColour = this.test.df.replace(
        ['name', 'colour'],
        'r',
        'rrr',
      );

      expect(resultName.toArray()).to.deep.equal(
        this.test.replaceNameResultDf.toArray(),
      );
      expect(resultName.columns).to.deep.equal(
        this.test.replaceNameResultDf.columns,
      );

      expect(resultNameColour.toArray()).to.deep.equal(
        this.test.replaceNameColourResultDf.toArray(),
      );
      expect(resultNameColour.columns).to.deep.equal(
        this.test.replaceNameColourResultDf.columns,
      );
    });

    it('Should throw an error when a type other than an array is passed as first parameter', function () {
      expect(() => {
        this.test.df.replace(1, 'r', 'rrr');
      }).to.throw();
    });

    it('Should throw an error when a type other than a string is passed for first and second parameters', function () {
      expect(() => {
        this.test.df.replace(['name'], 1, 'rrr');
      }).to.throw();
      expect(() => {
        this.test.df.replace(['name'], 'r', 1);
      }).to.throw();
    });

    it('Should throw an error when referencing a non-existent column', function () {
      expect(() => {
        this.test.df.replace(['nonExistentColumn'], 'r', 'rrr');
      }).to.throw();
    });

    it('Should throw an error if an incorrect number of arguments are passed', function () {
      expect(() => {
        this.test.df.replace();
      }).to.throw();
      expect(() => {
        this.test.df.replace(['name'], 'r', 'rrr', 1);
      }).to.throw();
    });
  });
  ...
  describe('replaceAll()', function () {
    beforeEach(function () {
      ...
      this.currentTest.replaceAllNameColourResultDf =
        smallDataFrame4ReplaceAllNameColour;
    });

    it('Should return a new DataFrame with values correctly replaced across the specified columns', function () {
      const resultName = this.test.df.replaceAll(['name'], 'r', 'rrr');
      const resultNameColour = this.test.df.replaceAll(
        ['name', 'colour'],
        'r',
        'rrr',
      );
      ...
      expect(resultName.toArray()).to.deep.equal(
        this.test.replaceAllNameResultDf.toArray(),
      );
      expect(resultName.columns).to.deep.equal(
        this.test.replaceAllNameResultDf.columns,
      );

      expect(resultNameColour.toArray()).to.deep.equal(
        this.test.replaceAllNameColourResultDf.toArray(),
      );
      expect(resultNameColour.columns).to.deep.equal(
        this.test.replaceAllNameColourResultDf.columns,
      );
    });

    it('Should throw an error when a type other than an array is passed as first parameter', function () {
      expect(() => {
        this.test.df.replaceAll(1, 'r', 'rrr');
      }).to.throw();
    });

    it('Should throw an error when a type other than a string is passed for first and second parameters', function () {
      expect(() => {
        this.test.df.replaceAll(['name'], 1, 'rrr');
      }).to.throw();
      expect(() => {
        this.test.df.replaceAll(['name'], 'r', 1);
      }).to.throw();
    });

    it('Should throw an error when referencing a non-existent column', function () {
      expect(() => {
        this.test.df.replaceAll(['nonExistentColumn'], 'r', 'rrr');
      }).to.throw();
    });

    it('Should throw an error if an incorrect number of arguments are passed', function () {
      expect(() => {
        this.test.df.replaceAll();
      }).to.throw();
      expect(() => {
        this.test.df.replaceAll(['name'], 'r', 'rrr', 1);
      }).to.throw();
    });
  });
  ...
  describe('regexReplace()', function () {
    beforeEach(function () {
      ...
      this.currentTest.replaceAllNameGlobalResultDf =
        smallDataFrame4RegexReplaceNameGlobal;
      this.currentTest.replaceAllNameColourGlobalResultDf =
        smallDataFrame4RegexReplaceNameColourGlobal;
    });

    it('Should return a new DataFrame with values correctly replaced across the specified columns', function () {
      const resultName = this.test.df.regexReplace(['name'], /r/i, 'rrr');
      const resultNameGlobal = this.test.df.regexReplace(
        ['name'],
        /r/gi,
        'rrr',
      );
      const resultNameColourGlobal = this.test.df.regexReplace(
        ['name', 'colour'],
        /r/gi,
        'rrr',
      );
      ...
      expect(resultNameGlobal.toArray()).to.deep.equal(
        this.test.replaceAllNameGlobalResultDf.toArray(),
      );
      expect(resultNameGlobal.columns).to.deep.equal(
        this.test.replaceAllNameGlobalResultDf.columns,
      );

      expect(resultNameColourGlobal.toArray()).to.deep.equal(
        this.test.replaceAllNameColourGlobalResultDf.toArray(),
      );
      expect(resultNameColourGlobal.columns).to.deep.equal(
        this.test.replaceAllNameColourGlobalResultDf.columns,
      );
    });

    it('Should throw an error when a type other than an array is passed as first parameter', function () {
      expect(() => {
        this.test.df.regexReplace(1, /r/i, 'rrr');
      }).to.throw();
    });

    it('Should throw an error when a type other than a string is passed for first and second parameters', function () {
      expect(() => {
        this.test.df.regexReplace(['name'], 1, 'rrr');
      }).to.throw();
      expect(() => {
        this.test.df.regexReplace(['name'], /r/i, 1);
      }).to.throw();
    });

    it('Should throw an error when referencing a non-existent column', function () {
      expect(() => {
        this.test.df.regexReplace(['nonExistentColumn'], /r/i, 'rrr');
      }).to.throw();
    });

    it('Should throw an error if an incorrect number of arguments are passed', function () {
      expect(() => {
        this.test.df.regexReplace();
      }).to.throw();
      expect(() => {
        this.test.df.regexReplace(['name'], /r/i, 'rrr', 1);
      }).to.throw();
    });
  });
  ...
  describe('unionByName()', function () {
    ...
    it('Should return a new DataFrame including rows from both DataFrames being unioned', function () {
      const resultUnionByName = this.test.df.unionByName(this.test.df2);

      expect(resultUnionByName.toArray()).to.deep.equal(
        this.test.unionByNameResultDf.toArray(),
      );
      expect(resultUnionByName.columns).to.deep.equal(
        this.test.unionByNameResultDf.columns,
      );
      expect(resultUnionByName.size()[0]).to.deep.equal(
        this.test.df.size()[0] + this.test.df2.size()[0],
      );
    });

    it('Should throw an error when a type other than a DataFrame is passed as first parameter', function () {
      expect(() => {
        this.test.df.unionByName(1);
      }).to.throw();
    });

    it('Should throw an error when DataFrames have different columns', function () {
      expect(() => {
        this.test.df.unionByName(this.test.df4);
      }).to.throw();
    });
  });
});
